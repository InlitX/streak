...
<img src="assets/banner.png" alt="Streak, минималистичный, приватный трекер привычек без рекламы" width="100%" />
...
<img src="assets/icon.svg" width="72" alt="Логотип Streak" />
...
- Встроенные звуки (дождь, коричневый шум, тёплый пэд) или свои треки, по
...
- **Классический или Минимальный** стиль: список привычек с нижней панелью или
...
- Десять языков, ещё больше открыто на Weblate
...
[**F-Droid**](https://f-droid.org/packages/com.streak.app/) это самый простой
...
> Наружу ведут только те ссылки, которые вы открываете сами.

---

## 🌍 Переводы

Streak полностью говорит на **английском, испанском, русском и китайском**,
а **немецкий, португальский, украинский, польский, французский
и индонезийский** уже в пути; новые языки очень приветствуются.
